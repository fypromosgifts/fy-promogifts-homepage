(function () {
  ...
  function injectStyle() {
    ...
    style.textContent =
      ...
      "@media(max-width:720px){.nav .nav-actions{display:none!important}.hero-ctas a[href*='wa.me']{display:none!important}.hero-line{white-space:normal!important}.hero-copy h1{max-width:100%!important;font-size:clamp(36px,10vw,44px)!important}.hero-grid,.hero-copy{min-width:0!important}.fy-floating-cta{left:16px!important;right:auto!important;bottom:calc(16px + env(safe-area-inset-bottom,0px))!important;gap:10px}.fy-floating-cta a{width:52px;height:52px}.fy-floating-wa svg{width:29px;height:29px}.fy-floating-form svg{width:24px;height:24px}.fy-floating-tip{display:none}}" +
