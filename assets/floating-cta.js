(function () {
  ...
  function injectStyle() {
    ...
    style.id = STYLE_ID;
    style.textContent =
      ".fy-floating-cta{position:fixed;right:22px;bottom:calc(22px + env(safe-area-inset-bottom,0px));z-index:2147483000;display:flex;flex-direction:column;gap:12px;pointer-events:none;font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,Arial,sans-serif}" +
      ...
      "@media(max-width:720px){.fy-floating-cta{right:16px;bottom:calc(16px + env(safe-area-inset-bottom,0px));gap:10px}.fy-floating-cta a{width:52px;height:52px}.fy-floating-wa svg{width:29px;height:29px}.fy-floating-form svg{width:24px;height:24px}.fy-floating-tip{display:none}}" +
